...
Базовые сущности по-прежнему остаются Helm release, поэтому во время обновления workloads не пересоздаются и не затрагиваются.
...
Перед обновлением изучите этот список, чтобы понимать влияние на ваши workloads.
...
Следующие внутренние изменения не влияют напрямую на application workloads, но важны
